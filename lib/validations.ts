...
export const SignInSchema = z.object({
    email: z.string().min(1, {message: 'Please provide a valid email address'}),
    password: z.string().min(8, 'Password must be 8 characters long.').max(12, {message: 'Password cannot exceed 12 characters.'}),
});
